...
class AppColors {
  ...
  static const Color transparentBlack = Color(0xB3121312);
  static const Color transparent = Color(0x00121312);
  static const Color semitransparentBlack = Color(0x80121312);
